...
public class PredicateEnabledSlot extends SlotItemHandler
{
    ...
    public PredicateEnabledSlot(Predicate predicate, IItemHandler itemHandler, int index, int xPosition, int yPosition)
    {
