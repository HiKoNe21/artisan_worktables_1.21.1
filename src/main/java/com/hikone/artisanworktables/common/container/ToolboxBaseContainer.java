...
public abstract class ToolboxBaseContainer extends ContainerBase
{
    private static final int NUM_ROWS = 3;

    private ToolboxBlockEntity tile;

    public ToolboxBaseContainer(MenuType<? extends ToolboxBaseContainer> containerType, int id, Level world, BlockPos blockPos, Inventory playerInventory)
    {
