...
public class DynamicStackHandler extends ObservableStackHandler implements ITileDataItemStackHandler
{
    ...
    private class ItemStackList extends NonNullList<ItemStack>
    {
