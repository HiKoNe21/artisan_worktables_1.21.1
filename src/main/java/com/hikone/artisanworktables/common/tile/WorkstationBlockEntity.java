...
public class WorkstationBlockEntity extends SecondaryInputBaseBlockEntity
{
    ...
    {
        // serialization
        super(ArtisanWorktablesMod.TileEntityTypes.WORKSTATION, pos, state, ArtisanWorktablesMod.getProxy().getTileDataService());
    }

    public WorkstationBlockEntity(BlockPos pos, BlockState state, EnumType type)
    {
        super(ArtisanWorktablesMod.TileEntityTypes.WORKSTATION, pos, state, ArtisanWorktablesMod.getProxy().getTileDataService(), type);
    }
