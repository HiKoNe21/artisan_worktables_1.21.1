        ...
        extends SecondaryInputBaseBlockEntity
{
    ...
    {
        // serialization
        super(ArtisanWorktablesMod.TileEntityTypes.WORKSHOP, pos, state, ArtisanWorktablesMod.getProxy().getTileDataService());
    }

    public WorkshopBlockEntity(BlockPos pos, BlockState state, EnumType type)
    {
        super(ArtisanWorktablesMod.TileEntityTypes.WORKSHOP, pos, state, ArtisanWorktablesMod.getProxy().getTileDataService(), type);
    }
