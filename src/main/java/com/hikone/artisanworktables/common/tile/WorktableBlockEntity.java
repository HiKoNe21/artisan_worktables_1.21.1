...
public class WorktableBlockEntity extends BaseBlockEntity
{
    ...
    {
        // serialization
        super(ArtisanWorktablesMod.TileEntityTypes.WORKTABLE, pos, state, ArtisanWorktablesMod.getProxy().getTileDataService());
    }

    public WorktableBlockEntity(BlockPos pos, BlockState state, EnumType type)
    {
        super(ArtisanWorktablesMod.TileEntityTypes.WORKTABLE, pos, state, ArtisanWorktablesMod.getProxy().getTileDataService(), type);
    }
