...
import com.hikone.artisanworktables.common.tile.SecondaryInputBaseBlockEntity;
...
public class CSPacketWorktableClear extends SPacketTileEntityBase<CSPacketWorktableClear>
{
    ...
    @Override
    protected IMessage<CSPacketWorktableClear> onMessage(CSPacketWorktableClear message, IPayloadContext context, BlockEntity tileEntity)
    {
    ...
    public static void clear(BaseBlockEntity tileEntity, int clearFlags)
    {
        ...
        if (tileEntity instanceof SecondaryInputBaseBlockEntity && (clearFlags & CLEAR_SECONDARY_INPUT) == CLEAR_SECONDARY_INPUT)
        {
