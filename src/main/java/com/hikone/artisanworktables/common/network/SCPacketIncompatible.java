...
public class SCPacketIncompatible implements IMessage<SCPacketIncompatible>, IMessageHandler<SCPacketIncompatible, SCPacketIncompatible>
{
    ...
    @OnlyIn(Dist.CLIENT)
    @Override
    public SCPacketIncompatible onMessage(SCPacketIncompatible message, IPayloadContext context)
    {
