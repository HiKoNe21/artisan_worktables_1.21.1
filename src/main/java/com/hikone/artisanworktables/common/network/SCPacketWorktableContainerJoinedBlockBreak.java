...
import com.hikone.artisanworktables.common.network.spi.packet.PacketBlockPosBase;
...
public class SCPacketWorktableContainerJoinedBlockBreak extends PacketBlockPosBase<SCPacketWorktableContainerJoinedBlockBreak>
{
    ...
    @OnlyIn(Dist.CLIENT)
    @Override
    public IMessage<SCPacketWorktableContainerJoinedBlockBreak> onMessage(SCPacketWorktableContainerJoinedBlockBreak message, IPayloadContext context)
    {
        Minecraft minecraft = Minecraft.getInstance();
        Player player = minecraft.player;
        Level world = minecraft.level;

        if (player != null && world != null && player.containerMenu instanceof BaseContainer)
        {
