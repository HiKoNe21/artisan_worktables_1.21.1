...
import com.hikone.artisanworktables.common.util.HashCodeHelper;
...
public class ArtisanRecipeBuilder
{
    ...
    private int width;
    private int height;
    private ShapedRecipePattern shapedPattern;
    ...
    {
        this.tools.add(new ToolEntry(tool, damage, matchNbt, null));
        return this;
    }
    ...
    public ArtisanRecipeBuilder setShapedPattern(ShapedRecipePattern pattern)
    {
        this.shapedPattern = pattern;
        this.ingredients = pattern.ingredients();
    ...
    public ArtisanRecipeShaped buildShaped(EnumType type) throws Exception
    {
        ...
        ShapedRecipePattern pattern = (this.shapedPattern != null)
                ? this.shapedPattern
                : new ShapedRecipePattern(this.width, this.height, this.ingredients, Optional.empty());
