...
import com.hikone.artisanworktables.common.block.*;
...
public class BlockRegistrationEventHandler
{
    ...
    public void on(RegisterEvent event)
    {
        ...
        ArtisanWorktablesMod.Blocks.TOOLBOX = toolboxBlock;
        ArtisanWorktablesMod.Blocks.MECHANICAL_TOOLBOX = mechanicalToolboxBlock;

        event.register(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(ArtisanWorktablesMod.MODID, ToolboxBlock.NAME), () -> toolboxBlock);
        event.register(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(ArtisanWorktablesMod.MODID, ToolboxMechanicalBlock.NAME), () -> mechanicalToolboxBlock);
    }
    ...
    private void register(RegisterEvent event, SoundType soundType, EnumType type)
    {
        ...
        {
            this.register(event, EnumTier.WORKTABLE, type.getName(), new MageWorktableBlock(soundType, 2.0f, 3.0f));
            this.register(event, EnumTier.WORKSTATION, type.getName(), new MageWorkstationBlock(soundType, 3.0f, 6.0f));
            this.register(event, EnumTier.WORKSHOP, type.getName(), new MageWorkshopBlock(soundType, 4.0f, 12.0f));
        }
        else
        {
            this.register(event, EnumTier.WORKTABLE, type.getName(), new WorktableBlock(type, soundType, 2.0f, 3.0f));
            this.register(event, EnumTier.WORKSTATION, type.getName(), new WorkstationBlock(type, soundType, 3.0f, 6.0f));
            this.register(event, EnumTier.WORKSHOP, type.getName(), new WorkshopBlock(type, soundType, 4.0f, 12.0f));
        }
    }
    ...
    private void register(RegisterEvent event, EnumTier tier, String name, Block block)
    {
        ...
        event.register(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath(ArtisanWorktablesMod.MODID, registryName), () -> block);
