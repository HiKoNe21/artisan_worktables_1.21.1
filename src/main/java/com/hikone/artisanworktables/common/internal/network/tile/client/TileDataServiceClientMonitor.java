...
public class TileDataServiceClientMonitor
{
    ...
    private static final CacheLoader<BlockPos, TileDataServiceClientMonitor> CACHE_LOADER = new CacheLoader<BlockPos, TileDataServiceClientMonitor>()
    {
        ...
        {
            return new TileDataServiceClientMonitor(() -> ArtisanWorktablesModClientConfig.tileDataServiceMonitorUpdateIntervalTicks, TOTAL_INTERVAL_COUNT);
        }
    };
    ...
    static
    {
        ...
        TOTAL = new TileDataServiceClientMonitor(() -> ArtisanWorktablesModClientConfig.tileDataServiceMonitorUpdateIntervalTicks, TOTAL_INTERVAL_COUNT);
    ...
    {
        // Update all the monitors at the start of the client tick.
        
        if (!Minecraft.getInstance().isPaused() && ArtisanWorktablesModClientConfig.enableTileDataServiceMonitor)
        {
            TOTAL.update();
    ...
    {
        if (ArtisanWorktablesModClientConfig.enableTileDataServiceMonitor)
        {
            // --- Total ---
