...
public final class RecipeInjector
{
    ...
    {
        Ingredient[] inputs = new Ingredient[]{Ingredient.of(new ItemStack(Items.APPLE)), Ingredient.of(new ItemStack(Items.POTATO)), Ingredient.of(new ItemStack(Items.BLAZE_ROD))};
                                ...
                                for (int o = 0; o < 3; o++)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        ArtisanRecipe artisanRecipe = builder
                                                .setRecipeId(ResourceLocation.fromNamespaceAndPath(ArtisanWorktablesMod.MODID, "test_recipe_" + id))
                                                .setWidth(5)
                                                .setHeight(2)
