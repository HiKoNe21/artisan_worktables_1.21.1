package com.hikone.artisanworktables.common.sound;
...
public final class ModSounds
{
    ...
    public static final ResourceLocation CRAFT_MEME_ID = ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "craft_meme");
