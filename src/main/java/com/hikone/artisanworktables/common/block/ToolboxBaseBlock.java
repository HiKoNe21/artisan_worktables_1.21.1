...
import com.hikone.artisanworktables.common.container.ToolboxContainerProvider;
...
public abstract class ToolboxBaseBlock extends Block implements EntityBlock
{
    ...
    {
        super(Properties.of().sound(SoundType.WOOD).strength(hardness, resistance).noOcclusion());
    }
    ...
    public List<ItemStack> getDrops(@Nonnull BlockState blockState, LootParams.Builder builder)
    {
        ...
        if (tileentity instanceof ToolboxBlockEntity tile)
        {
