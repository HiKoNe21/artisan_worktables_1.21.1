...
public class WorkshopBlock extends BaseBlock
{
    public static final VoxelShape VOXEL_SHAPE = Shapes.or(
            Block.box(0, 8, 0, 16, 16, 16), // top
            Block.box(1, 7, 1, 15, 8, 15), // inset
            Block.box(0, 0, 0, 16, 7, 16) // bottom
    );

    public WorkshopBlock(EnumType type, SoundType soundType, float hardness, float resistance)
    {
