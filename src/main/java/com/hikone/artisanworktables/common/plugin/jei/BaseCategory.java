...
public abstract class BaseCategory<R> implements IRecipeCategory<R>
{
    ...
    public BaseCategory(EnumType type, EnumTier tier, String titleKey, IDrawable background, IDrawable icon, RecipeType<R> recipeType)
    {
        this.type = type;
        this.tier = tier;
