package com.hikone.artisanworktables.common.plugin.crafttweaker;
...
import com.hikone.artisanworktables.common.recipe.ArtisanRecipeBuilder;
...
import com.hikone.artisanworktables.common.util.RecipeInjector;
...
public class ZenRecipe
{
    ...
    public ZenRecipe tool(IIngredient tool, int damage, boolean matchNbt)
    {
        ...
        if (matchNbt && tool instanceof IItemStack itemStack)
        {
            matchStack = itemStack.getInternal();
        }
    ...
    public void register(String name)
    {
        ...
        try
        {
            ...
            CraftTweakerAPI.apply(new ActionAddRecipe<>(manager, holder, this.isShaped ? "shaped" : "shapeless"));
    ...
    public static void injectTestRecipes()
    {
        ...
        {
            IRecipeManager<ArtisanRecipe> manager = managerFor(recipe);
            RecipeHolder<ArtisanRecipe> holder = manager.createHolder(recipe.getRecipeId(), recipe);
