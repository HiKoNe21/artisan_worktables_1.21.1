...
public class CategoryDrawHandler
{
    ...
    private String getExperienceString(@Nonnull ArtisanRecipe recipe)
    {
        if (recipe.getExperienceRequired() > 0)
        {
            ...
            {
                return I18n.get("jei.artisanworktables.xp.required", recipe.getExperienceRequired()
                );
            }
        }
    ...
    private void drawExtraOutputChanceString(Font font, GuiGraphics guiGraphics, float secondaryOutputChance, int positionX, int positionY)
    {
    ...
    private void drawToolDamageString(ArtisanRecipe recipe, Font font, GuiGraphics guiGraphics, int offsetX, int offsetY)
    {
        ...
        for (int i = 0; i < toolCount; i++)
        {
            ...
            guiGraphics.drawString(font, label, (int) (offsetX - font.width(label) * 0.5f), offsetY + (22 * i), 0xFFFFFFFF, false);
        }
    }
    ...
    private void drawExperienceString(Font font, GuiGraphics guiGraphics, int backgroundHeight, @Nullable String experienceString)
    {
        ...
        guiGraphics.drawString(font, experienceString, TEXT_MARGIN, backgroundHeight - 10, 0xFF80FF20, false);
    }

    private void drawSecondaryIngredientString(@Nonnull ArtisanRecipe recipe, GuiGraphics guiGraphics, int backgroundHeight, Font font, @Nullable String experienceString)
    {
        ...
        guiGraphics.drawString(font, label, x, y, SecondaryIngredientDisplay.color(recipe), false);
    }
}
