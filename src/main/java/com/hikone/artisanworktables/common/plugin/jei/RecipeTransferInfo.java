...
public class RecipeTransferInfo<C extends BaseContainer> implements IRecipeTransferInfo<C, ArtisanRecipe>
{
    ...
    public RecipeTransferInfo(Class<C> containerClass, EnumTier tier, EnumType type, RecipeType<ArtisanRecipe> recipeType)
    {
    ...
    public boolean canHandle(C container, ArtisanRecipe recipe)
    {
        ...
        return this.type == type && this.tier != null && this.tier.getId() <= tableTierId;
    }
