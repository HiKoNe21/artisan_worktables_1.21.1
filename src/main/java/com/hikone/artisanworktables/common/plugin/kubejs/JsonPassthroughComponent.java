        ...
        implements RecipeComponent<JsonElement>
{
    ...
    public static final RecipeComponentType<JsonElement> TYPE = RecipeComponentType.unit(ResourceLocation.fromNamespaceAndPath(ArtisanWorktablesMod.MODID, "json"), INSTANCE);
