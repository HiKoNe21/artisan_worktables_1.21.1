...
// */
//public class JsonPassthroughComponent implements RecipeComponent<JsonElement>
//{
//    public static final JsonPassthroughComponent INSTANCE = new JsonPassthroughComponent();
//
//    public static final RecipeComponentType<JsonElement> TYPE =
//            RecipeComponentType.unit(ResourceLocation.fromNamespaceAndPath(ArtisanWorktablesMod.MODID, "json"), INSTANCE);
//
//    private static final Codec<JsonElement> CODEC =
//            Codec.PASSTHROUGH.xmap(dynamic -> dynamic.convert(JsonOps.INSTANCE).getValue(), json -> new Dynamic<>(JsonOps.INSTANCE, json));
//
//    @Override
