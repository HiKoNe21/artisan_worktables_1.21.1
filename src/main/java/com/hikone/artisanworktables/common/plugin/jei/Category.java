...
public class Category extends BaseCategory<ArtisanRecipe>
{
    private final CategorySetupHandler categorySetupHandler;
    private final CategoryDrawHandler categoryDrawHandler;

    public Category(EnumTier tier, EnumType type, String titleKey, IDrawable background, IDrawable icon, RecipeType<ArtisanRecipe> recipeType, CategorySetupHandler categorySetupHandler, CategoryDrawHandler categoryDrawHandler)
    {
