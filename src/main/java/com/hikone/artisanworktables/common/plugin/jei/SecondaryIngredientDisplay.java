...
final class SecondaryIngredientDisplay
{
    ...
    private static final String TOOLTIP_CONSUMED_KEY = "jei.artisanworktables.secondary.consumed";
    private static final String TOOLTIP_NOT_CONSUMED_KEY = "jei.artisanworktables.secondary.not_consumed";
    private static final String LABEL_CONSUMED_KEY = "jei.artisanworktables.secondary.status.consumed";
    private static final String LABEL_NOT_CONSUMED_KEY = "jei.artisanworktables.secondary.status.not_consumed";
