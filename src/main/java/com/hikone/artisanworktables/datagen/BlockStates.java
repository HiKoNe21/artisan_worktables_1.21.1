package com.hikone.artisanworktables.datagen;

import com.hikone.artisanworktables.ArtisanWorktablesMod;
import com.hikone.artisanworktables.common.block.MageBaseBlock;
...
public class BlockStates extends BlockStateProvider
{
    ...
    {
        super(packOutput, ArtisanWorktablesMod.MODID, existingFileHelper);
    }
    ...
    protected void registerStatesAndModels()
    {
        ...
        this.generateSimpleBlock(ArtisanWorktablesMod.Blocks.TOOLBOX, this.getExistingModel("block/toolbox/toolbox"));
        this.generateSimpleBlock(ArtisanWorktablesMod.Blocks.MECHANICAL_TOOLBOX, this.getExistingModel("block/mechanical_toolbox/mechanical_toolbox"));
    }
    ...
    private void generateMageTable(Block block, String path, String tableTier, String tableType)
    {
        ...
        this.getVariantBuilder(block).partialState().with(MageBaseBlock.ACTIVE, false).addModels(new ConfiguredModel(model)).partialState().with(MageBaseBlock.ACTIVE, true).addModels(new ConfiguredModel(modelActive));
    }
