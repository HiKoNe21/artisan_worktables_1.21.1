...
public abstract class ContainerBase extends AbstractContainerMenu
{
    ...
    public ContainerBase(@Nullable MenuType<?> type, int id, Inventory inventoryPlayer)
    {
        super(type, id);
    ...
    private boolean containerSlotItemStackMerge(int slotIndex, ItemStack itemStackResult, Slot slot, ItemStack itemStack)
    {
        ...
        { // the item is in the player's inventory or hotbar
            ...
            { // subclass didn't specify a target slot
