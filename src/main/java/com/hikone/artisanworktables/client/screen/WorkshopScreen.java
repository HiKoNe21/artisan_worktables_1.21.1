...
import com.hikone.artisanworktables.client.screen.element.GuiElementFluidTankLarge;
...
public class WorkshopScreen extends BaseScreen
{
    ...
    {
        this.guiContainerElementAdd(new GuiElementFluidTankLarge(this,tile.getTank(), tile.getBlockPos(), overlayColor, 8, 17));
    }
}
