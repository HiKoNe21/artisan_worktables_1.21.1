...
public class GuiElementMageEffect extends GuiElementBase
{
    ...
    public GuiElementMageEffect(GuiContainerBase guiBase, BaseContainer container, int elementX, int elementY)
    {
    ...
    {
        if (this.elementIsMouseInside(mouseX, mouseY) && !this.container.slots.get(0).getItem().isEmpty())
        {
            float radius = 21f;
            int count = 12;
