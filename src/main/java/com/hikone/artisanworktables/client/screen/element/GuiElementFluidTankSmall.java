...
public class GuiElementFluidTankSmall extends GuiElementFluidTankBase implements IGuiElementClickable, IGuiElementTooltipProvider
{
    ...
    public GuiElementFluidTankSmall(GuiContainerBase guiBase, FluidTank fluidTank, BlockPos blockPos, int overlayColor, int elementX, int elementY)
    {
    ...
    public void drawForegroundLayer(PoseStack matrixStack, int mouseX, int mouseY)
    {
        ...
        RenderSystem.setShaderColor(((this.overlayColor >> 16) & 0xFF) / 255f, ((this.overlayColor >> 8) & 0xFF) / 255f, (this.overlayColor & 0xFF) / 255f, 1f);

        GuiHelper.drawModalRectWithCustomSizedTexture(matrixStack, this.elementX, this.elementY, 0, ReferenceTexture.TEXTURE_FLUID_OVERLAY.getPositionX(), ReferenceTexture.TEXTURE_FLUID_OVERLAY.getPositionY(), ELEMENT_OVERLAY_WIDTH, ELEMENT_OVERLAY_HEIGHT, ReferenceTexture.TEXTURE_FLUID_OVERLAY.getWidth(), ReferenceTexture.TEXTURE_FLUID_OVERLAY.getHeight());
